...
PUBLIC_CHANNEL_ID  = 1338126297666424874  # Canal público donde se muestran resultados sensibles, este es el canal puntuacion
SPECIAL_HELP_CHANNEL = 1338747286901100554  # Canal especial para que el owner reciba la lista extendida de comandos, canal lista de comandos
